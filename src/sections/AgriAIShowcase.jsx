      ...
      case 1:
        return (
          ...
          >
            ...
            />
            {/* Scanning Line */}
            <div className="absolute left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#22c55e] to-transparent pointer-events-none agri-scan-line" style={{ boxShadow: "0 0 10px #22c55e, 0 0 20px #22c55e" }} />
            ...
            <div className="absolute top-6 left-6 font-mono text-[10px] text-emerald-400 bg-black/60 backdrop-blur-md px-3 py-1.5 border border-emerald-500/20 tracking-widest uppercase flex items-center gap-2 rounded">
              ...
              INFERENCE_ACTIVE // EDGE_YOLOV9 <span className="text-[8px] text-[#666] font-mono tracking-widest uppercase ml-1">(SIMULATED)</span>
            </div>
          ...
          >
            ...
            >
              <div className="flex items-center justify-between gap-4 w-full">
                ...
                <span className="text-[8px] text-[#666] font-mono tracking-widest uppercase">(SIMULATED)</span>
              </div>
              <div className="w-full h-[1px] bg-white/10"></div>
              
              <div>
                <span className="text-[#666] block text-[8px] mb-1">TARGET DETECTED</span>
                <span className="text-white font-bold text-xs uppercase">Puccinia graminis (Rust)</span>
              </div>
              
              <div>
                <span className="text-[#666] block text-[8px] mb-1">RECOMMENDED ACTION</span>
                <span className="text-emerald-400 font-bold uppercase text-[10px]">Apply organic copper fungicide</span>
              </div>
          ...
          {steps.map((step, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* Step Number */}
                <div className={`font-mono text-xs font-bold w-6 h-6 rounded-full flex items-center justify-center border ${
                  isActive ? "border-accent-blue text-accent-blue bg-accent-blue/5" : "border-[#333] text-[#555]"
                }`}>
                  0{idx + 1}
                </div>
                ...
                <div className="flex flex-col">
                  <span className={`font-mono text-[10px] tracking-widest uppercase ${isActive ? "text-accent-blue" : "text-text-secondary"}`}>
                    {step.label}
                  </span>
                  <span className={`text-sm font-bold tracking-tight mt-1 ${isActive ? "text-white" : "text-[#555] group-hover:text-[#888]"}`}>
                    {step.title}
                  </span>
                </div>
              </button>
