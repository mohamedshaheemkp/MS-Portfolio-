...
export default function SystemsArchive() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="w-1.5 h-1.5 rounded-full bg-[#22c55e]"></span>3 SYSTEMS
      </motion.div>
      ...
      <div
        className="flex items-center justify-center cursor-pointer group w-full px-4"
      ...
      >
        ...
        <div className="relative w-[22vw] h-[18vw] min-w-[140px] min-h-[110px] flex items-end justify-center z-10">
          ...
          <div className="absolute inset-x-2 md:inset-x-4 bottom-2 h-[80%] z-10 flex flex-col items-center justify-end pointer-events-none">
            ...
            >
              <span className="font-mono text-[8px] md:text-[10px] text-text-secondary uppercase">
                03 Portfolio V2
              </span>
            </motion.div>
            ...
            >
              <span className="font-mono text-[8px] md:text-[10px] text-white uppercase font-bold tracking-wider">
                01 AgriAI
              </span>
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="flex flex-col items-center mt-4 md:mt-8">
              <span className="font-display font-black text-[#222] text-[3vw] md:text-[2vw] tracking-tighter">
                MS
              </span>
            </div>
