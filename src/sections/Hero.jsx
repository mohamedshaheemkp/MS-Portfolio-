...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      ref={containerRef}
      className="relative w-full h-screen flex flex-col justify-between px-6 md:px-12 lg:px-24 overflow-hidden bg-bg"
    >
        ...
        >
          <h1 className="contents">
            ...
            <motion.div
              ...
              className="overflow-visible flex ml-0 md:ml-12 lg:ml-24"
            >
              <VariableProximity
                label="SHAHEEM"
                fromFontVariationSettings="'wght' 100, 'wdth' 100"
          ...
          <motion.div
            ...
            className="mt-8 md:mt-12 flex flex-col gap-6 ml-0 md:ml-12 lg:ml-24"
          >
