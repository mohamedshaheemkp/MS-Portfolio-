...
export default function DesignCabinet() {
  ...
  const xDesign = useTransform(
    scrollYProgress,
    [0, 1],
    reduceMotion ? ['0%', '0%'] : ['-12%', '12%']
  )
  const xCabinet = useTransform(
    scrollYProgress,
    [0, 1],
    reduceMotion ? ['0%', '0%'] : ['12%', '-12%']
  )
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[800px] px-6">
        <div className="mb-6 flex items-center gap-4 font-mono text-xs uppercase tracking-widest text-text-secondary">
          <span className="h-px w-8 bg-border" /> 05 — DESIGN CABINET
        </div>
