...
import brand2 from '../assets/branding/brand 2.webp'
import brand4 from '../assets/branding/brand 4.webp'
...
import brand1 from '../assets/Logo/brand 1.webp'
...
export const designCategories = {
  posters: {
    title: 'Posters',
    description: 'Editorial Poster Collection',
    year: '2024 — Present',
    images: [poster1, poster2, poster3, poster4, poster5, poster6],
  },
  branding: {
    title: 'Branding',
    description: 'Identity & Architecture',
    year: '2023 — Present',
    images: [graficoyBranding, royalGryphonBranding, revoroBranding, brand2, brand4],
  },
  logos: {
    title: 'Logos',
    description: 'Aesthetic Explorations',
    year: '2022 — Present',
    images: [kfcLogo, blueFlameLogo, revoroLogo, brand1, brand3, logo1, logo2, logo3],
  },
}
